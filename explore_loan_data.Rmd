...
```
table(df_s$Term)
Borrowoers who choose 36 months as a lenght of the loan (middle term) have the highest Borrower Rate
...
We notice a negative correlation between mean rate and mean loan especially for debt consolidation and home improvement, as the mean loan amount increases, the rate decreased, we could be interested in calculating by how much of dollars approximately the loan increases
To do that we'll create a new variable, called 
